...
class Encoder(torch.nn.Module):
    def __init__(self,output_dim,first_layer_dropout,metadata):
        super().__init__()

        self.graph_layer_1 = to_hetero(GraphBlock(-1,output_dim,first_layer_dropout,False),metadata,aggr="mean")
...
class Model(torch.nn.Module):
    def __init__(self,metadata,supervision_types,first_layer_dropout):
        super().__init__()
          
        self.encoder = Encoder(64,first_layer_dropout,metadata)
