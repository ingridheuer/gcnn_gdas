...
#hice medio trampa acá e indexé las cosas desde 0, es para ahorrarme dolores de cabeza cuando pase a python
graph_node_table$node_idx = graph_node_table$node_idx - 1
...
graph_edge_table$edge_idx = graph_edge_table$edge_idx - 1
